...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1>เพิ่ม<span class="small"> สาส์นจากผู้บริหาร</span></h1>
    </div>
    <ul class="app-breadcrumb breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="{{ url('dashboard/message/create')}}">เพิ่มข้อมูล</a></li>
    </ul>
  </div>
  @if (session('alert'))
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        <div class="box-body">
          <form action="{{ url('dashboard/message')}}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
