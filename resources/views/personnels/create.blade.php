...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1>เพิ่ม<span class="small"> บุคลากร</span></h1>
    </div>
    <ul class="app-breadcrumb breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="{{ url('dashboard/personnel/create')}}">เพิ่มข้อมูล</a></li>
    </ul>
  </div>
  @if (session('alert'))
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        <div class="box-body">
          <form action="{{ url('dashboard/personnel')}}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="form-row">
              <div class="col-md-3">
              ...
              <div class="col-md-9">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="major" placeholder="Major" name="major" value="{{ old('major') }}">
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group col-md-6">
                    <label for="tel">เบอร์โทรศัพท์</label>
                    <input type="tel" class="form-control" id="tel" placeholder="Telephone number" name="tel" value="{{ old('tel') }}">
                  </div>
                  <div class="form-group col-md-6">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="teach" placeholder="Teach" name="teach" value="{{ old('teach') }}">
                  </div>
                </div>
...
<script type="text/javascript">
  $("#image").fileinput({
    ...
    removeLabel: "ลบ/เปลี่ยน",
    defaultPreviewContent: '<img src="/images/personnels/personnel.jpg" class="img-fluid" alt="Your Avatar"><h6 class="text-muted">Click to select</h6>',
    layoutTemplates: {
