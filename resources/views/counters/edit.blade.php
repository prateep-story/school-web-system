...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1>แก้ไข<span class="small"> ข้อมูลเชิงสถิติ</span></h1>
    </div>
    <ul class="app-breadcrumb breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="{{ url('dashboard/counter/create')}}">แก้ไข</a></li>
    </ul>
  </div>
  @if (session('alert'))
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        <div class="box-body">
          <form action="{{ url('dashboard/counter/'.$counter->id)}}" method="post">
            ...
            <div class="form-row">
              ...
              <div class="col-md-8">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" id="title"
                    placeholder="Title" name="title" value="{{ $counter->title }}">
                  @if ($errors->has('title'))
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control {{ $errors->has('quantity') ? 'is-invalid' : '' }}" id="quantity"
                  placeholder="Quantity" name="quantity" value="{{ $counter->quantity }}">
