...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1>เพิ่ม<span class="small"> อัลบั้มภาพ</span></h1>
    </div>
    <ul class="app-breadcrumb breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="{{ url('dashboard/gallery/create')}}">เพิ่มข้อมูล</a></li>
    </ul>
  </div>
  @if (session('alert'))
          ...
          <form action="{{ url('dashboard/gallery')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control {{ $errors->has('gallery') ? 'is-invalid' : '' }}" id="gallery"
                placeholder="Gallery" name="gallery" value="{{ old('gallery') }}">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control datetimepicker-input {{ $errors->has('event_date') ? 'is-invalid' : '' }}"
                name="event_date" id="event_date" data-toggle="datetimepicker" data-target="#event_date" value="{{old('event_date')}}"
