...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1>แก้ไข<span class="small"> หมวดหมู่เอกสาร</span></h1>
    </div>
    <ul class="app-breadcrumb breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="{{ url('dashboard/document/create')}}">แก้ไข</a></li>
    </ul>
  </div>
  @if (session('alert'))
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        <div class="box-body">
          <form action="{{ url('dashboard/document/'.$document->id)}}" method="post">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control {{ $errors->has('document') ? 'is-invalid' : '' }}" id="document"
                placeholder="Document" name="document" value="{{$document->document}}">
